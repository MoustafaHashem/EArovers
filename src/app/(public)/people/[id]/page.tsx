  ...
  return (
    <main className="flex min-h-screen flex-col bg-transparent text-foreground overflow-x-hidden font-cairo" dir="rtl">
      ...
      <div className="container mx-auto px-4 pt-32 pb-12 z-10 max-w-4xl">
        <Link href="/hierarchy" className="inline-flex items-center text-[#161e35] dark:text-cyan-400 hover:opacity-80 mb-8 transition-colors font-bold">
          <ArrowRight className="w-5 h-5 ml-2" />
          العودة للهيكل التنظيمي
        </Link>
        
        <div className="glass-card p-8 md:p-12 rounded-3xl border border-[#d4a373]/25 dark:border-white/10 shadow-xl relative overflow-hidden">
          {/* Background Accent */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-[#161e35]/10 dark:bg-cyan-500/10 rounded-full blur-3xl -z-10 translate-x-1/2 -translate-y-1/2" />
          
          <div className="flex flex-col md:flex-row gap-8 items-start">
            <div className="shrink-0">
              <div className="w-32 h-32 md:w-48 md:h-48 rounded-2xl bg-[#f0eee6] dark:bg-[#080b10] border-2 border-[#161e35]/30 dark:border-cyan-400/50 shadow-md overflow-hidden flex items-center justify-center">
                {person.avatarUrl ? (
                  <Image src={person.avatarUrl} alt={person.fullName} width={200} height={200} className="w-full h-full object-cover" />
                ) : (
                  <User size={64} className="text-[#64748b] dark:text-gray-500" />
                )}
              </div>
            </div>
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="pt-4 border-t border-black/10 dark:border-white/10">
                <h3 className="text-lg font-bold text-[#0b1a30] dark:text-white mb-2 flex items-center gap-2">
                  <User className="w-5 h-5 text-[#161e35] dark:text-cyan-400" />
                  النبذة التعريفية
                </h3>
                <p className="text-[#334155] dark:text-gray-300 leading-relaxed whitespace-pre-wrap">
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-8">
          <div className="glass-card p-6 rounded-2xl border border-[#d4a373]/25 dark:border-white/10 shadow-md">
            <h2 className="text-xl font-bold text-[#0b1a30] dark:text-white mb-6 flex items-center gap-2">
              <History className="w-6 h-6 text-[#161e35] dark:text-cyan-400" />
              تاريخ المناصب
            </h2>
          ...
          <div className="glass-card p-6 rounded-2xl border border-[#d4a373]/25 dark:border-white/10 shadow-md">
            <h2 className="text-xl font-bold text-[#0b1a30] dark:text-white mb-6 flex items-center gap-2">
              <Award className="w-6 h-6 text-[#161e35] dark:text-cyan-400" />
              الدروع والإنجازات
            </h2>
