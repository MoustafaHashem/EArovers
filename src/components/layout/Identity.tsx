      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-right relative z-10">
        ...
        <div className="flex flex-col items-center md:items-start gap-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="https://www.instagram.com/eng_asu_rovers/?hl=en" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-[#E4405F] hover:text-white transition-colors" title="Instagram">
              <InstagramIcon size={20} />
            </a>
            <a href="https://www.youtube.com/@eng_asurovers3282/featured" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-[#FF0000] hover:text-white transition-colors" title="YouTube">
              <YoutubeIcon size={20} />
            </a>
            <a href="https://m.soundcloud.com/eng_asu-rovers" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:bg-[#ff5500] hover:text-white transition-colors" title="SoundCloud">
              <CloudIcon size={20} />
            </a>
          </div>
        </div>
