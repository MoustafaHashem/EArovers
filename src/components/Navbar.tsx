    ...
    <div className="fixed top-4 inset-x-0 z-50 flex justify-center px-4 pointer-events-none">
      ...
      >
        <div
          className={cn(
            "flex items-center",
            isScrolled ? "justify-center gap-8" : "w-full",
          )}
        >
          {/* Left Side (Logo) */}
          <motion.div
            ...
            className={cn(
              "flex items-center",
              isScrolled ? "" : "flex-1 justify-start",
            )}
          >
          ...
          <motion.div
            layout
            ref={navRef}
            className="hidden lg:flex relative items-center gap-2 bg-white/5 border border-white/10 rounded-full p-1 backdrop-blur-md"
          >
            ...
            {navLinks.map((link) => {
              ...
              if (isHashLink) {
                isActive =
                  pathname === routePart && activeHash === `#${hashPart}`;
              } else {
                  ...
                  onClick={(e) => {
                    ...
                    if (isHashLink || isSamePageHome) {
                      ...
                      const step = (timestamp: number) => {
                        ...
                        window.scrollTo(
                          0,
                          startPosition + distance * easeOutQuart(percent),
                        );
          ...
          <motion.div
            ...
            className={cn(
              "flex items-center",
              isScrolled ? "" : "flex-1 justify-end mr-8",
            )}
          >
            <AnimatePresence>
              {!isScrolled && (
