...
const HERO_SLIDES: HeroSlide[] = [
  {
    ...
    title: "عشيرة جوالة هندسة عين شمس: عائلة تمتد جذورها من جيل إلى جيل",
    subtitle: "إرث نعتز به، تاريخ نصنعه، وأنشطة لا تتوقف",
  ...
  },
  {
    ...
    subtitle: "نبني بيدينا، نتقن أصول الصنعة، ونخلد تاريخنا في فنون الدروع الكشفية",
  ...
  },
  {
    ...
    subtitle: "أفعال تسبق الكلمات، ومسؤولية نعتز بحملها لخدمة مجتمعنا ووطننا",
  ...
  },
  {
    ...
    badge: "البطولات والمسابقات",
    title: "صدارة دائمة في البطولات والمهارات الفنية",
    subtitle: "ننافس لنحصد المراكز ونبتكر لنترك بصمتنا المميزة في كل مكان",
    buttonText: "استكشاف البطولات",
    buttonLink: "/fame",
  },
  {
    id: 5,
    ...
    badge: "قيم وريادة",
    title: "قيادة واعدة وقيم راسخة: شجرة عشيرتنا العريقة",
    subtitle: "من نحن، وما هي قيمنا الجوهرية؟",
    buttonText: "اعرفنا عن قرب",
